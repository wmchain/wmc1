...
The Wmc Core project has been designed to support multiple localisations. This makes adding new phrases, and completely new languages easily achievable. For managing all application translations, Wmc Core makes use of the Transifex online translation management tool.
...
See the [Transifex Wmc project](https://www.transifex.com/projects/p/wmc/) to assist in translations. You should also join the translation mailing list for announcements - see details below.
...
`contrib/wmc-qt.pro` takes care of generating `.qm` (binary compiled) files from `.ts` (source files) files. It’s mostly automated, and you shouldn’t need to worry about it.
...
You can find the Wmc translation project at [https://www.transifex.com/projects/p/wmc/](https://www.transifex.com/projects/p/wmc/).
...
The Transifex Wmc project config file is included as part of the repo. It can be found at `.tx/config`, however you shouldn’t need change anything.
...
Check official forum at [https://dashtalk.org/forums/wmc-worldwide-collaboration.88/](https://dashtalk.org/forums/wmc-worldwide-collaboration.88/).
