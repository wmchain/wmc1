...
The Wmc Core daemon can be configured to act as a trusted "border
router", implementing the wmc wire protocol and relay, making
...
The ZeroMQ feature in Wmc Core requires ZeroMQ API version 4.x or
...
These options can also be provided in wmc.conf.
