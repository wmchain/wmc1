...
This mechanism has been integrated into Bitcore-Node-Wmc which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/wmchain/insight-api-wmc#web-socket-api](https://github.com/wmchain/insight-api-wmc#web-socket-api) 
* API: [https://github.com/wmchain/insight-api-wmc#instantsend-transactions](https://github.com/wmchain/insight-api-wmc#instantsend-transactions) 
...
By default, the Wmc Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Wmc Core daemon:
