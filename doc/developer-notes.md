...
Wmc Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 13052.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 13051 for connections and services them.
...
However, in open source software such as Wmc Core, where everyone uses
...
pay attention to for reviewers of Wmc Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Wmc Core uses tinyformat, which is type safe. Leave them out to avoid confusion
