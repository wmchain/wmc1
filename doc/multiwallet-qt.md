...
Only requiring some minor changes is wmc.cpp.
...
Changes to wmc.cpp
----------------------
wmc.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
