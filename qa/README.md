...
Every pull request to the Wmc Core repository is built and run through
...
```
  ...
  --srcdir=SRCDIR       Source directory containing dashd/wmc-cli
                        (default: ../../src)
...
blocks (25*500=12500 WMC) in its wallet.
