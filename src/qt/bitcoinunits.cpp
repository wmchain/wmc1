...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        ...
        {
            case WMC: return QString("Wmc");
            case mDASH: return QString("Milli-Wmc (1 / 1" THIN_SP_UTF8 "000)");
            case uDASH: return QString("Micro-Wmc (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case duffs: return QString("Ten Nano-Wmc (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
    {
        switch(unit)
        {
            case WMC: return QString("TestDashs");
