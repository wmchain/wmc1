    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Wmc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Wmc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and wmc: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Wmc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Wmc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Wmc Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Wmc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Wmc addresses"));
    ...
    openAction->setStatusTip(tr("Open a wmc: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Wmc Core help message to get a list with possible Wmc Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Wmc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Wmc network", "", count));
}
...
{
    QString strTitle = tr("Wmc Core"); // default title
