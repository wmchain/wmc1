    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("WMC-light"), QVariant("light"));
    ui->theme->addItem(QString("WMC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("WMC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("WMC-traditional"), QVariant("trad"));
