    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Wmc Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Wmc Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  wmc-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Wmc in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 WMC, 0.1 WMC, 1 WMC and 10 WMC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Wmc Core is shutting down...") + "<br /><br />" +
